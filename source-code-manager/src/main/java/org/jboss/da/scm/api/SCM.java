...
public interface SCM {
    ...
    /**
     * Clone repository and return directory where the repository is located. The returned File object is weakly cached. As long
     * as it is referenced the repository will stay clonned. The repository will stay cloned for at least
