...
class CLITool(object):
    ...
    def printUsage(self): 
        ...
        message += ("        When G:A:V is not specified, reads list of G:A:Vs from standard input.\n")
        message += ("\n")
        ...
        message += ("\n")
        message += ("    python " + sys.argv[0] + " lookup [GROUP_ID:ARTIFACT_ID[:PACKAGING[:CLASSIFIER]]:VERSION[:SCOPE]] [--products PRODUCTS] [--productIDs IDS] [--suffix SUFFIX] [--group GROUP\n")
        ...
        message += ("        --suffix SUFFIX  use given version suffix (default: redhat)\n")
